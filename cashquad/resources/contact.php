...
<?php require 'menudetails_top_resources.php'; ?>
         ...
         <!-- content section -->
            <section id="big-gradient" class="section is-transparent">
                <!-- Container -->
                <div style="margin-top:-150px;" align="center" class="container is-centered">
                    <!-- Divider -->
                    <div class="divider is-centered"></div>
                    <!-- Title & subtitle -->
                    <h2 class="title is-light is-semibold has-text-centered is-spaced">Contact us</h2>

<p style="color:#fff;font-size:1.2em;"><i class="fa fa-envelope"></i>&nbsp;cashquad@gmail.com</p>
<p style="color:#fff;font-size:1.2em;"><i class="fa fa-phone"></i>&nbsp;+1-202-555-0191</p>
<p style="color:#fff;font-size:1.2em;"><i class="fa fa-map-marker"></i>&nbsp;3322  Grant Street, Oak Hill Texas</p>
