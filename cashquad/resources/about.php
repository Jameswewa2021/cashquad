...
<?php require 'menudetails_top_resources.php'; ?>
         ...
         <!-- content section -->
            <section id="big-gradient" class="section is-transparent">
                <!-- Container -->
                <div align="center" class="container is-centered">
                    <!-- Divider -->
                    <div class="divider is-centered"></div>
                    <!-- Title & subtitle -->
                    <h2 class="title is-light is-semibold has-text-centered is-spaced">About Us</h2>
                    <h4 class="subtitle is-6 is-light has-text-centered is-compact">CashQuad was founded by a highly specialized team with backgrounds in gaming and Bitcoin technology. Created to help its members pursue their financial goals, CashQuad has established a business model where average people, without taking huge financial risk, are able to benefit from the new trend of making money by playing fun online games.
The company’s aim is to make the process of making money fun and enjoyable. At CashQuad we value your happiness as much as your financial stability.</h4><br>
<h3 class="title is-light is-semibold has-text-centered is-spaced">Smart people make smart decisions, so become a CashQuad member today and experience the difference.</h3>
               
            <img src="../images/gradientlogoresized.png">

            <h3 class="title is-light is-semibold has-text-centered is-spaced">Earn with every click!</h3>
                </div>
