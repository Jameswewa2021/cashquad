...
$subject="CashQuad Password Reset";

$mes="Operation successful here is your password reset code:<br><br>"."<b>".$reset_code."</b>";
...
<script type="text/javascript">
	window.location.href='reset_password.php?info=reset_email_sent&t=s&email=<?php echo $email; ?>';
</script>
<?php
}
?>