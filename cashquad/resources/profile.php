...
<h2 class="title is-light is-semibold has-text-centered is-spaced has-space-up">Personal information</h2>
            </div>
          </div>
...
<!--  <div class="divider"></div>
 <h4 class="title is-6 is-tight is-light"><i class="fa fa-user"></i> Personal information</h4> -->
...
$email=$rowprof['email'];
$phone="+".$rowprof['country_code'].$rowprof['phone_number'];
}
...
<form method="post" action="submit_change_avatar.php" enctype="multipart/form-data">
<div class="field">
   <input type="file" id="upload_file" name="upload_file" required /> 
</div>
    <button class="button is-success" type="submit" name='submit_image' value="Upload sample">
     <i class="fa fa-edit"></i>&nbsp;Change avatar (32 &times; 32)
    </button>
</form>
