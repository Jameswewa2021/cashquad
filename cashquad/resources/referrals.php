...
<h2 class="title is-light is-semibold has-text-centered is-spaced has-space-up">My Referrals</h2>
            </div>
          </div>
...
<!-- ............... -->
 ...
 <h4 class="title is-6 is-tight is-light"><i class="fa fa-info-circle"></i> Below is a list of people who joined the platform using your invite link</h4>
...
$sqlr=mysqli_query($con,"SELECT * FROM tbl_users WHERE referral_id='$user_id' ORDER BY id desc");
if (mysqli_num_rows($sqlr)>0) {
?>
<h4 class="title is-6 is-tight is-light">Total referrals: <?php echo mysqli_num_rows($sqlr); ?></h4>
...
<tr>
  ...
  <td>
    <?php
    $naccount_level=$rowr['account_level'];
...
?>
<div class="notification is-info">You have no referrals yet. Please copy and use the link at the dashboard to invite referrals.</div>
<?php
}
