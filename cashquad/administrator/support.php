...
<h2 class="title is-light is-semibold has-text-centered is-spaced has-space-up">Customer support</h2>
            </div>
          </div>
...
<div class="has-padding-right">
  <a class="button is-primary" target="_blank" href="https://tidio.com/panel">LOGIN TO TIDIO CHAT</a>
</div>
